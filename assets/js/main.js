...
const textArray = ["Rutuja", "a Developer", "a Designer"];
        let textIndex = 0;
        let charIndex = 0;
        ...
        function typeEffect() {
            ...
            const displayText = document.querySelector(".animated-name");
...
document.querySelector('.cs_btn').addEventListener('click', function(event) {
            event.preventDefault();
            document.getElementById('contact_me').scrollIntoView({ behavior: 'smooth' });
        });
